        ...
        try(final Connection connection = DriverManager.getConnection("jdbc:hsqldb:mem:mydb", "sa", "")) {
            ...
            statement.executeUpdate(
                    "CREATE MEMORY TABLE PUBLIC.BOOK("+
                            ...
                            "PUBLISHDATE DECIMAL(12,0), TAGS VARCHAR(255), BINDING VARCHAR(20))");
            statement.executeUpdate(
                    "INSERT INTO PUBLIC.BOOK (PUBLISHER_PUBLISHERID, ISBN, NAME, PRICE, PUBLISHDATE, TAGS, BINDING) "+
                    "VALUES (1, 123, 'JBoss Seam', 18.39, 1234567890, '101,102', 'Paperback')");
            statement.executeUpdate(
                    "INSERT INTO PUBLIC.BOOK (PUBLISHER_PUBLISHERID, ISBN, NAME, PRICE, PUBLISHDATE, TAGS, BINDING) "+
                    "VALUES (1, 128, 'Bootstrap', 18.39, 1234567896, '101', 'Hardback')");
            ...
            statement.executeUpdate(
                    "CREATE MEMORY TABLE PUBLIC.READER("+
                            ...
                            "BOOK_BOOKID INTEGER, NAME VARCHAR(50))");
            statement.executeUpdate(
                    "INSERT INTO PUBLIC.READER (BOOK_BOOKID, NAME) "+
                    "VALUES (1, 'lly')");
