        ...
        try(final Connection connection = DriverManager.getConnection("jdbc:hsqldb:mem:mydb", "sa", "")) {
            ...
            statement.executeUpdate(
                    "CREATE MEMORY TABLE PUBLIC.BOOK("+
                            ...
                            "ISBN INTEGER, NAME VARCHAR(50), PRICE DECIMAL(8,2), PUBLISHDATE DECIMAL(12,0))");
            statement.executeUpdate(
                    "INSERT INTO PUBLIC.BOOK (ID, ISBN, NAME, PRICE, PUBLISHDATE) "+
                    "VALUES (1, 123, 'JBoss Seam', 18.39, 1234567890)");
            statement.close();
        }
    }
}
